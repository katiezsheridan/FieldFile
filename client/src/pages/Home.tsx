    ...
    <div className="bg-gradient-to-b from-primary-50 to-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center">
          ...
          <div className="flex justify-center gap-4">
            ...
            <Link
              to="/demo"
              className="px-8 py-4 bg-white text-primary-600 text-lg font-medium rounded-lg border-2 border-primary-600 hover:bg-primary-50 transition-colors"
            >
              Watch Demo
            </Link>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-8 rounded-lg shadow-md">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">Activity Tracking</h3>
          ...
          <div className="bg-white p-8 rounded-lg shadow-md">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">Property Mapping</h3>
            <p className="text-gray-600">
          ...
          <div className="bg-white p-8 rounded-lg shadow-md">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">Service Booking</h3>
            <p className="text-gray-600">
      ...
      <div className="bg-primary-600 text-white py-16">
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          <Link
            to="/register"
            className="inline-block px-8 py-4 bg-white text-primary-600 text-lg font-medium rounded-lg hover:bg-gray-50 transition-colors shadow-lg"
          >
            Start Free Trial
          </Link>
        </div>
