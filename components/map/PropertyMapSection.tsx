...
export default function PropertyMapSection({
  ...
  return (
    <section className="bg-white border border-field-wheat rounded-lg overflow-hidden">
      {/* Header */}
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 px-6 py-4 border-b border-field-wheat/50">
        <div>
          <h2 className="text-xl font-semibold text-field-ink">Property Map</h2>
